...
def get_Vel_Cost(nodes, srcObs, Start, Goal, alpha, Velocity, d_ ):
    
    print '--> Velocity map...'    
    vmap = FastMarching.fmm(srcObs, -1 , nodes, d_, cross = True)
    vmap.processFMM()
    '''
    ...
    '''
    print '--> CDMap...'
    CDmap = FastMarching.fmm(Goal, Start, nodes, d_, cross = True)
    
    return CDmap.processFMM()
